...
SET LocalLibsInclude=-LIBPATH:..\WetClay_Library\Src\Dependencies\lib\OpenGL\
SET LocalLibs=glew32s.lib

pushd ..\build
	call %VisualStudio% %VSFlags% %VSIncludes% ..\WetClay_Library\Config.cpp %GlobalLibs% %VSLinkerFlags% -LIBPATH:..\WetClay_Library\Src\Dependencies\lib\OpenGL\ %LocalLibs%
popd
